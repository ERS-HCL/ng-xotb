...
export class ColorComponent implements OnInit {
  ...
  resultContrast() {
    ...
    reultCompliantText = this.smallTextContrastDetails.wcagResults.WCAG_AA
      ? 'Your combination is AA compliant.\n'
      : 'Your combination is not AA compliant.\n';

    reultCompliantText += this.largeTextContrastDetails.wcagResults.WCAG_AA
      ? 'Your combination is AAA compliant.\n'
